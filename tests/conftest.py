...
# WARNING: Ensure imports from `pdf_coordinates_learner` comes after this line
from pdf_coordinates_learner import app, settings, db  # noqa
from pdf_coordinates_learner.cli import create_user, cli  # noqa
